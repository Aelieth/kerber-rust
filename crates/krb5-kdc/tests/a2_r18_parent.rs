//! R18 statuses that fail at parent `f4b307c` (inject this file only).
...
use krb5_kdc::{
    ...
    documented_admin_id, documented_host, pa_enc_timestamp, pac_from_ticket_part, sign_reply_pac,
