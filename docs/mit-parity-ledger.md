...
Counts (after sub-plan-05 setkey-keepold, `pw_expiration` base, `ss_parse`, delete-prompt and exit-status rows):
**270** = A1 116 + A2 67 + A3 55 + A4 32.
exact 82 · stricter-documented 12 · deviation 95 ·
