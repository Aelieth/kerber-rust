...
| [4556](https://www.rfc-editor.org/rfc/rfc4556) | PKINIT | Types in `krb5-types::pkinit`; software DH/ECDH path is partial. |
| [6113](https://www.rfc-editor.org/rfc/rfc6113) | FAST | Types in `krb5-types::fast`. |
