...
| `kadmin-gate.sh` | MIT `kadmin` vs `krb5-kadmind` 749 | add/cpw/get/list/mod/chrand/ktadd/`ktadd -norandkey`/purgekeys/setstr/`renprinc`/del then `kinit extra` | harness |
