...
| 6 | Admin tools, plugins, propagation, remaining parity | **In tree** (`krb5-admin` ACL-enforced session, ktadd, kpasswd with kvno rotation, kprop-equivalent dump/load). Not MIT RPC ABI. |
